...
- `source_markdown`: 비교할 Markdown 경로. 비워 두면 HWPX는 파일명 충돌 규칙을 반영한 정본 `extracted/*.md` 경로를 자동 탐색할 수 있음
...
- 결과는 `extracted/<추출명>.oneocr.md` sidecar로 남으며, 같은 stem의 형식이 여러 개면 `신고서-hwpx.oneocr.md`처럼 확장자 suffix를 유지할 수 있습니다.
